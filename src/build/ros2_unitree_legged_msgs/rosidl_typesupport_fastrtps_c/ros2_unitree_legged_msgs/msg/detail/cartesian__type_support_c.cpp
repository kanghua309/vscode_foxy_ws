...
#include "ros2_unitree_legged_msgs/msg/detail/cartesian__rosidl_typesupport_fastrtps_c.h"
...
using _Cartesian__ros_msg_type = ros2_unitree_legged_msgs__msg__Cartesian;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Cartesian__ros_msg_type * ros_message = static_cast<const _Cartesian__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr << ros_message->x;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Cartesian__ros_msg_type * ros_message = static_cast<_Cartesian__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr >> ros_message->x;
  }
...
static uint32_t _Cartesian__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_unitree_legged_msgs__msg__Cartesian(
...
static size_t _Cartesian__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_unitree_legged_msgs__msg__Cartesian(
...
static message_type_support_callbacks_t __callbacks_Cartesian = {
...
static rosidl_message_type_support_t _Cartesian__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Cartesian,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_unitree_legged_msgs, msg, Cartesian)() {
  return &_Cartesian__type_support;
}
