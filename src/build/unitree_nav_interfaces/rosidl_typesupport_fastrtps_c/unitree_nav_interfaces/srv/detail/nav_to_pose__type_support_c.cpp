...
#include "unitree_nav_interfaces/srv/detail/nav_to_pose__rosidl_typesupport_fastrtps_c.h"
...
using _NavToPose_Request__ros_msg_type = unitree_nav_interfaces__srv__NavToPose_Request;
...
size_t get_serialized_size_unitree_nav_interfaces__srv__NavToPose_Request(
  const void * untyped_ros_message,
...
static uint32_t _NavToPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unitree_nav_interfaces__srv__NavToPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_nav_interfaces
size_t max_serialized_size_unitree_nav_interfaces__srv__NavToPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _NavToPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unitree_nav_interfaces__srv__NavToPose_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unitree_nav_interfaces, srv, NavToPose_Request)() {
...
using _NavToPose_Response__ros_msg_type = unitree_nav_interfaces__srv__NavToPose_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_nav_interfaces
size_t get_serialized_size_unitree_nav_interfaces__srv__NavToPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavToPose_Response__ros_msg_type * ros_message = static_cast<const _NavToPose_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_unitree_nav_interfaces__srv__NavToPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unitree_nav_interfaces
size_t max_serialized_size_unitree_nav_interfaces__srv__NavToPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _NavToPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_unitree_nav_interfaces__srv__NavToPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unitree_nav_interfaces, srv, NavToPose_Response)() {
...
// already included above
// #include "unitree_nav_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "unitree_nav_interfaces/srv/nav_to_pose.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unitree_nav_interfaces, srv, NavToPose)() {
