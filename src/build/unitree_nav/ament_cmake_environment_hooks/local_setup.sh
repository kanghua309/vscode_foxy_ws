...
: ${AMENT_CURRENT_PREFIX:="/workspaces/my_ros2_ws/src/install/unitree_nav"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/unitree_nav/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/unitree_nav/environment/path.sh"
